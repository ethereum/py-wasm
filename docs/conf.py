# -*- coding: utf-8 -*-
#
# py-wasm documentation build configuration file, created by
...
latex_documents = [
  ('index', 'wasm.tex', 'py-wasm Documentation',
   'Jason Carver', 'manual'),
]
...
man_pages = [
    ('index', 'wasm', 'py-wasm Documentation',
     ['Jason Carver'], 1)
]
